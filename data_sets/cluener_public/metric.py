...
f1_score('dev.txt','dev_out_fgm.txt')
f1_score('dev.txt','dev_out_nofgm.txt')
# f1_score('./dataset/msra_test_proceed1.txt','./dataset/msra_test_proceed_out_1.txt')
# f1_score('./dataset/people_daily_ner_1000_proceed1.txt','./dataset/people_daily_ner_1000_proceed_out_1hhh.txt')
# f1_score('./dataset/resume_test_proceed1.txt','./dataset/resume_test_proceed_out_1.txt')
# f1_score('./dataset/weibo_test_proceed.txt','./dataset/weibo_test_proceed_out_1.txt')
# f1_score('./dataset/clu_dev_proceed1.txt','./dataset/clu_dev_out_proceed1.txt')
